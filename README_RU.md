...
В настройках отдельно задаются **Параллельные скачивания** и **Параллельные
декодеры медиа**. По умолчанию одновременно работают два декодера; скачивания могут
идти быстрее и ждать свободного декодера без расходования его таймаута. Повышайте
число декодеров постепенно: слишком много процессов может замедлить обработку.
