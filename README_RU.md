...
Промпт 1.2.0 явно задаёт связи между полями текста, чисел, стилей и неопределённости.
Локальная проверка остаётся строгой и показывает конкретный код нарушенного правила.
Уже проверенные результаты промпта 1.1.0 используются с их исходными метаданными,
а новые описания создаются по 1.2.0.
