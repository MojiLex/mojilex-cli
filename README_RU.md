...
статичные тайлы, необходимые для проверки пазлов; анимации не требуют повторного
открытия всех кадров. Отсутствующие тайлы восстанавливаются без повторных запросов
...
с меткой неопределённости; программа не выдумывает движение. При сборке описаний
