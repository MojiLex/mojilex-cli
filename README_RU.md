...
Если сохранённую базу нельзя прочитать, описания из кеша доступны с предупреждением.
Движение из кеша показывается как неопределённое, когда проверенный сохранённый
результат недоступен. Просмотр не меняет кеш и не расходует запросы ИИ.
